!> @file blas.f
!> @details Given a vector x of length n, this function calculates the
...
!> @details constant times a vector plus a vector.
...
!> @details copies a vector, x, to a vector, y.
!>     uses unrolled loops for increments equal to one.
!>     jack dongarra, linpack, 3/11/78.
...
!> @details forms the dot product of two vectors.
!>     uses unrolled loops for increments equal to one.
!>     jack dongarra, linpack, 3/11/78.
...
!> @details scales a vector by a constant.
