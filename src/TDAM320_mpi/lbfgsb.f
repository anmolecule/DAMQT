...
c======================= The end of setulb =============================
!> @details Solves bound constarined optimization problem
...
C     WRITE(6,*) "going to projgr",g(1),g(2),g(3),f  
      call projgr(n,l,u,nbd,x,g,sbgnrm)
C     WRITE(6,*) "came from projgr",sbgnrm,f 
...
c======================= The end of mainlb =============================
!
!> @details This subroutine initializes iwhere and projects the initial x to
...
!> @details This subroutine computes the product of the 2m x 2m middle matrix 
...
c======================== The end of bmv ===============================
!> @details For given x, l, u, g (with sbgnrm > 0), and a limited memory
...
!> @details       This subroutine computes r=-Z'B(xcp-xk)-Z'g by using 
...
c======================= The end of cmprlb =============================
!> @details This subroutine checks the validity of the input data.
...
!> @details This subroutine forms  the LEL^T factorization of the indefinite
...
c======================= The end of formk ==============================
!> @details This subroutine forms the upper half of the pos. def. and symm.
...
!> @details     This subroutine counts the entering and leaving variables when
...
!> @details This subroutine sorts out the least element of t, and puts the
...
c====================== The end of hpsolb ==============================
!> @details This subroutine calls subroutine dcsrch from the Minpack2 library
...
!> @details This subroutine updates matrices WS and WY, and forms the
!>      middle matrix in B.
...
!> @details This subroutine prints the input data, initial point, upper and
...
!> @details This subroutine prints out new information after a successful
!>       line search. 
...
!> @details This subroutine prints out information when either a built-in
...
!> @details This subroutine computes the infinity norm of the projected
!>       gradient.
...
C       WRITE(6,*)"I AM IN projgr routine ",nbd(i),gi,sbgnrm
  15  continue
...
!> @details This routine contains the major changes in the updated version.
...
c====================== The end of subsm ===============================
!
!> @details This subroutine finds a step that satisfies a sufficient
...
!> @details This subroutine computes a safeguarded step for a search
