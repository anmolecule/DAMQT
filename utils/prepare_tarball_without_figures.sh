...
# echo "../$directorio/doc/manual/figs/*" ../$directorio/doc/manual/figs/*
# echo ls ../$directorio/doc/manual/figs/*
if [ "$1" != "" ]; then
   filename=$1  
else
   fecha=$(date "+%Y%m%d")
...
tar --wildcards -cvzh --exclude="../$directorio/doc/manual/figs" \
--exclude="../$directorio/doc/manual/figs/*" --exclude="bin" --exclude="bin/*" --exclude="release" \
